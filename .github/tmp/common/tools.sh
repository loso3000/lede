...
[ ! -d files/usr/share ] ||mkdir -p files/usr/share
[ ! -d ./package/emortal ] ||mkdir -p ./package/emortal
...
rm -rf ./package/add/other/up/tool/autocore
...
for sh_file in `ls ${GITHUB_WORKSPACE}/openwrt/package/common/*.sh`;do
